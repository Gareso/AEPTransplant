...
* Search bar and category filters (Comps, Media, Graphics, Design, 3D), persisted between sessions.
* Recent Projects list with up to 10 entries.
* Update Watcher: live dots on the panel when a loaded or recent project file changes on disk.
* Panel theme syncs automatically with After Effects' Light / Dark / Darkest skin.
