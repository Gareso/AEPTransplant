...
AEP Transplant works with Adobe After Effects **CC 2019 and later** on both macOS and Windows.

It is a **CEP extension** (not a script), so the installation is slightly different from a `.jsxbin` panel.
